...
mlops_version=python-sdk-v1   #options: aml-cli-v2 / python-sdk-v1 / python-sdk-v2 / rai-aml-cli-v2
orchestration=github-actions #options: github-actions / azure-devops
git_folder_location='/Users/luisademiranda/Dev/ml-projects'   #replace with the local root folder location where you want to create the project folder
project_name=curly-braces   #replace with your project name
github_org_name=luisamiranda   #replace with your github org name
project_template_github_url=git@github.com:luisamiranda/mlops-project-template.git  #replace with the url for the project template for your organization created in step 2.2, or leave for demo purposes
